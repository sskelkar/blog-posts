...
For someone coming from OOP background, a similarity between closures and objects will be immediately noticeable. Indeed, closures have been called as poor man’s objects (and vice-versa)! In fact when we create a class in TypeScript, it gets translated into a JavaScript closure.
